...
class PerspectiveCamera {
 public:
    ...
    glm::mat4 get_mvp(glm::mat4 &Projection, glm::mat4 &View, glm::mat4 &Model) {
        Projection = glm::perspective(glm::pi<float>() * 0.25f, 4.0f / 3.0f, 0.1f, 20000.f);
        // Projection = glm::ortho(-500.0f, 500.0f, -500.0f, 500.0f, 0.1f, 10000.f);
